        ...
        <c:if test="${succes!=true}">
          <div class="">
            ...
            <form role="" action="${pageContext.request.contextPath}/login" method="POST">
              <fieldset>
                <input class="" name="username" placeholder="Enter your login" autofocus required>
                <input class="" type="password" name="password" placeholder="enter your password" value="" required>
