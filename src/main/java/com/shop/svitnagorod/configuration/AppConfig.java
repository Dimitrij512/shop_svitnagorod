...
public class AppConfig extends WebMvcConfigurerAdapter {
  ...
  public JavaMailSenderImpl javaMailSenderImpl() {
    ...
    mailSenderImpl.setUsername(environment.getRequiredProperty("mail.sender.username"));
    mailSenderImpl.setPassword(environment.getRequiredProperty("mail.sender.password"));
